...
(function(){
  ...
  var D = {
    ...
    "Hand-poured scented candles, made in small batches. Coconut & soy wax, cotton wicks, considered scents.":{it:"Candele profumate colate a mano, in piccoli lotti. Cera di cocco e soia, stoppini di cotone, profumi ricercati.",pt:"Velas perfumadas feitas à mão, em pequenos lotes. Cera de coco e soja, pavios de algodão, fragrâncias selecionadas."},
    /* specs */
    "Coconut & soy wax":{it:"100% Cera di cocco e soia",pt:"100% Cera de coco e soja"},
    ...
    "Light Your Pride is a collection of decorative coconut & soy wax candles, handcrafted in Dublin in the colours of the rainbow flag. Each piece is made by hand — no two are exactly alike. Designed to be displayed, gifted and cherished, they carry no fragrance — only colour, form and meaning. A quiet celebration of pride, every single day.":{it:"Light Your Pride è una collezione di candele decorative in cera di cocco e soia, fatte a mano a Dublino nei colori della bandiera arcobaleno. Ogni pezzo è realizzato a mano — non ce ne sono due uguali. Pensate per essere esposte, regalate e custodite, non hanno profumo — solo colore, forma e significato. Una silenziosa celebrazione dell'orgoglio, ogni giorno.",pt:"Light Your Pride é uma coleção de velas decorativas em cera de coco e soja, feitas à mão em Dublin nas cores da bandeira do arco-íris. Cada peça é feita à mão — não há duas iguais. Criadas para exibir, presentear e guardar, não têm perfume — só cor, forma e significado. Uma celebração silenciosa do orgulho, todos os dias."},
    ...
    "Coconut & soy wax":{it:"Cera di cocco e soia",pt:"Cera de coco e soja"},
    ...
    "Our scented candles come in over thirty fragrances, handcrafted in a coconut & soy wax blend — pick your favourite for any collection or a custom order. (Light Your Pride is decorative and unscented.)":{it:"Le nostre candele profumate sono disponibili in oltre trenta fragranze, colate a mano in cera di cocco e soia — scegli la tua preferita per qualsiasi collezione o un ordine personalizzato. (Light Your Pride è decorativa e senza profumo.)",pt:"Nossas velas perfumadas têm mais de trinta fragrâncias, feitas à mão em cera de coco e soja — escolha a sua favorita para qualquer coleção ou um pedido personalizado. (Light Your Pride é decorativa e sem perfume.)"},
    ...
    "Hand-poured scented candles inspired by the Mediterranean coast — salt, driftwood and warm sea air. Coconut & soy wax, cotton wick, slow and clean to burn.":{it:"Candele profumate colate a mano, ispirate alla costa mediterranea — sale, legni e aria calda di mare. Cera di cocco e soia, stoppino di cotone, lente e pulite da bruciare.",pt:"Velas perfumadas feitas à mão, inspiradas na costa mediterrânea — sal, madeira e ar morno do mar. Cera de coco e soja, pavio de algodão, queima lenta e limpa."},
    ...
    "Each Mare candle is made with a coconut & soy wax blend and a cotton wick for a clean, even burn and a soft, lingering scent — the kind that turns an ordinary evening into something you remember.":{it:"Ogni candela Mare è fatta con cera di cocco e soia naturale e stoppino di cotone per una combustione pulita e uniforme e un profumo morbido e persistente — di quelli che trasformano una sera qualunque in un ricordo.",pt:"Cada vela Mare é feita com cera de coco e soja natural e pavio de algodão, para uma queima limpa e uniforme e uma fragrância suave e duradoura — daquelas que transformam uma noite comum em algo memorável."},
    ...
    "Soft, comforting scents poured by hand in a coconut & soy wax blend. With every candle, a part of what you spend goes to shelters and animals in need. Quiet comfort, with a purpose.":{it:"Profumi morbidi e avvolgenti colati a mano in cera di cocco e soia. Con ogni candela, parte di ciò che spendi va a rifugi e animali in difficoltà. Comfort silenzioso, con uno scopo.",pt:"Fragrâncias suaves e acolhedoras feitas à mão em cera de coco e soja. A cada vela, parte do que você gasta vai para abrigos e animais necessitados. Conforto silencioso, com propósito."},
    ...
    "Warm, meditative fragrances poured by hand in a coconut & soy wax blend, with a cotton wick for a clean, even burn. A small ritual to bring you back to yourself.":{it:"Fragranze calde e meditative colate a mano in cera di cocco e soia, con stoppino di cotone per una combustione pulita e uniforme. Un piccolo rituale per ritrovare te stesso.",pt:"Fragrâncias quentes e meditativas feitas à mão em cera de coco e soja, com pavio de algodão para uma queima limpa e uniforme. Um pequeno ritual para você se reencontrar."},
    ...
    "Every scent is hand-poured in a coconut & soy wax blend and can be made into any of our scented collections — or a custom order made just for you. Search, filter, and order yours on WhatsApp.":{it:"Ogni profumo è colato a mano in cera di cocco e soia naturale e può diventare una qualsiasi delle nostre collezioni profumate — o un ordine personalizzato solo per te. Cerca, filtra e ordina il tuo su WhatsApp.",pt:"Cada fragrância é feita à mão em cera de coco e soja natural e pode virar qualquer uma das nossas coleções perfumadas — ou um pedido personalizado só para você. Busque, filtre e peça a sua pelo WhatsApp."},
    ...
    "Wellness and massage candles, hand-poured in coconut, soy and shea butter. Light one to unwind — or let a massage candle melt into a warm, nourishing oil for the skin.":{it:"Candele wellness e da massaggio, colate a mano in cera di cocco e soia e burro di karité. Accendine una per rilassarti — o lascia che una candela da massaggio si sciolga in un olio caldo e nutriente per la pelle.",pt:"Velas de bem-estar e de massagem, feitas à mão em cera de coco e soja e manteiga de karité. Acenda uma para relaxar — ou deixe uma vela de massagem derreter num óleo morno e nutritivo para a pele."},
    "A caress, in candle form.":{it:"Una carezza, in forma di candela.",pt:"Uma carícia em forma de vela."},
    "Carezza is made for slowing down and taking care of yourself. Our wellness candles fill the room with calm, while our massage candles burn at a low, gentle heat and melt into a warm oil of coconut, soy and shea — ready to pour and massage into the skin. Soft, soothing and kind to you.":{it:"Carezza è pensata per rallentare e prendersi cura di sé. Le candele wellness riempiono la stanza di calma, mentre quelle da massaggio bruciano a un calore basso e delicato e si sciolgono in un olio caldo di soia e karité — pronto da versare e massaggiare sulla pelle. Morbida, lenitiva e gentile con te.",pt:"Carezza é feita para desacelerar e cuidar de você. As velas de bem-estar enchem o ambiente de calma, enquanto as de massagem queimam num calor baixo e suave e derretem num óleo morno de soja e karité — pronto para aplicar e massagear na pele. Suave, relaxante e gentil com você."},
    "Three ways to unwind":{it:"Tre modi per rilassarsi",pt:"Três formas de relaxar"},
    "Coconut, soy & shea wax":{it:"Cera di cocco e soia & karité",pt:"Cera de coco e soja & karité"},
