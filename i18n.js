...
(function(){
  ...
  var D = {
    ...
    "Shells & glass jar":{it:"Conchiglie & vasetto in vetro",pt:"Conchas & pote de vidro"},
    "10% to Outhouse":{it:"10% a Outhouse",pt:"10% para a Outhouse"},
    "See the collection →":{it:"Scopri la collezione →",pt:"Ver a coleção →"},
    ...
    "A past season — Mare stays available to order all year.":{it:"Una stagione passata — Mare resta ordinabile tutto l'anno.",pt:"Uma estação passada — Mare continua disponível para pedido o ano todo."},
    "A seasonal collection — Light Your Pride returns every June, and stays available to order all year.":{it:"Una collezione stagionale — Light Your Pride torna ogni giugno e resta ordinabile tutto l'anno.",pt:"Uma coleção sazonal — Light Your Pride volta todo mês de junho e continua disponível para pedido o ano todo."},
    ...
    "Choose a scent, then the format and colour you'd like it poured in. Tap a scent to start your order — we'll confirm everything with you on WhatsApp.":{it:"Scegli un profumo, poi il formato e il colore in cui vuoi che sia colato. Tocca un profumo per iniziare l'ordine — confermiamo tutto insieme su WhatsApp.",pt:"Escolha um aroma e depois o formato e a cor em que quer a vela. Toque num aroma para começar o pedido — confirmamos tudo com você no WhatsApp."},
    ...
    "Warm baking spice, sweet and rounded. The most autumn thing we make.":{it:"Spezia calda da forno, dolce e avvolgente. La cosa più autunnale che facciamo.",pt:"Especiaria quente de forno, doce e redonda. A coisa mais outonal que fazemos."},
    "Buttery caramel with a pinch of salt — comfort in a jar.":{it:"Caramello burroso con un pizzico di sale — conforto in un vasetto.",pt:"Caramelo amanteigado com uma pitada de sal — conforto num pote."},
    "Polished wood, leather and a hint of spice. Deep and grown-up.":{it:"Legno lucidato, cuoio e un tocco di spezia. Profondo e adulto.",pt:"Madeira polida, couro e um toque de especiaria. Profundo e adulto."},
    ...
    "Clove, orange peel and mulled spice — for when autumn tips into winter.":{it:"Chiodi di garofano, scorza d'arancia e spezie del vin brulé — per quando l'autunno diventa inverno.",pt:"Cravo, casca de laranja e especiarias de vinho quente — para quando o outono vira inverno."},
    "Choose this scent →":{it:"Scegli questo profumo →",pt:"Escolher este aroma →"},
    "See all 30+ scents →":{it:"Vedi tutti gli oltre 30 profumi →",pt:"Ver os mais de 30 aromas →"},
    "Choose your format":{it:"Scegli il formato",pt:"Escolha o formato"},
    "Three ways to pour it":{it:"Tre modi di colarla",pt:"Três formas de fazer"},
    "Every autumn scent can be poured in any of these. Prices depend on the size and finish you pick — tell us what you'd like and we'll quote on WhatsApp.":{it:"Ogni profumo autunnale può essere colato in ciascuno di questi formati. Il prezzo dipende dalla misura e dalla finitura che scegli — dicci cosa desideri e ti facciamo un preventivo su WhatsApp.",pt:"Qualquer aroma de outono pode ser feito em qualquer um destes formatos. O preço depende do tamanho e do acabamento — diga o que você quer e mandamos o orçamento no WhatsApp."},
    "Coconut & soy":{it:"Cocco & soia",pt:"Coco & soja"},
    "Travel size":{it:"Formato da viaggio",pt:"Tamanho de viagem"},
    "Moulded":{it:"Modellata",pt:"Moldada"},
    "Coconut & soy wax · cotton wick · reusable jar":{it:"Cera di cocco e soia · stoppino di cotone · vasetto riutilizzabile",pt:"Cera de coco e soja · pavio de algodão · pote reutilizável"},
    "Soy wax · lidded tin · small and giftable":{it:"Cera di soia · latta con coperchio · piccola e da regalare",pt:"Cera de soja · lata com tampa · pequena e fácil de presentear"},
    "Soy wax · free-standing · your colour":{it:"Cera di soia · senza contenitore · nel tuo colore",pt:"Cera de soja · sem recipiente · na sua cor"},
    "Ask for a price":{it:"Chiedi il prezzo",pt:"Peça o preço"},
    "Building a gift set? Tell us the scents and we'll wrap them together.":{it:"Vuoi comporre un set regalo? Dicci i profumi e li confezioniamo insieme.",pt:"Quer montar um kit de presente? Diga os aromas e embalamos tudo junto."},
    ...
    "Jar, tin or moulded pillar":{it:"Vasetto, latta o candela modellata",pt:"Pote, lata ou vela moldada"},
